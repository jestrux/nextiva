export default function Banner() {
    return (
        <section className="md:py-16 overflow-hidden px-4 md:px-0 flex flex-col gap-10 md:gap-16 items-center justify-center md:h-screens relative">
                ...
                <div className="flex-1 flex flex-col items-center text-center md:max-w-5xl">
                    <span className="mb-4 py-2 pl-3 pr-3.5 rounded-full bg-gradient-to-r from-content/10 via-content/10 to-content/0 font-light inline-flex items-center gap-1.5">
                        ...
                        <span className="opacity-60 text-xs md:text-base">
                            The #1 Business Conversation Platform
                        </span>
                    </span>
                    <h1 className="text-2xl md:text-6xl md:leading-tight mb-2 md:mb-4">
                        Amazing relationships start
                        <span className="hidden md:inline">
                            <br />
                        </span>{" "}
                        with a conversation
                    </h1>
                    <p className="mb-8 opacity-80 font-normal text-sm/loose md:text-xl/loose">
                        Meet Nextiva, an AI-powered conversational platform that
                        integrates all conversation channels, and powers
                        personalized experiences at scale throughout the entire
                        customer journey.
                    </p>
