  ...
  const platforms = [
    {
      icon: (
        ...
        >
          <path
            d="M7.33326 24H2.97139V12.1696H0V8.31792H2.97127V5.57715C2.97127 2.32932 4.28547 0 8.63553 0C9.55557 0 11 0.201761 11 0.201761V3.7783H9.48288C7.93705 3.7783 7.33349 4.28988 7.33349 5.70422V8.31792H10.9421L10.6208 12.1696H7.33337L7.33326 24Z"
            fill="#1877F2"
          />
        </svg>
      ),
      ...
      <div className="container">
        <div className="flex flex-col gap-2 items-center justify-center text-center">
          <h2 className="text-2xl md:text-6xl/tight font-medium">
            Never miss an online review... bring it
            <span className="hidden md:inline">
              <br />
            </span>
            together with all customer conversations
          </h2>
        </div>
