    ...
    <>
      <section className="md:py-20  md:px-0 ">
        <div className=" md:max-w-6xl mx-auto">
          ...
          <p className="mb-8  max-w-2xl opacity-80 font-normal text-sm/loose md:text-lg/loose">
            Our Board of Directors brings together wide experience, deep
            expertise, and sound judgment to help chart a strong path forward.
          </p>
        </div>
      </section>
      ...
      <section className={"pb-20 relative"}>
        ...
        <div className="md:max-w-6xl mx-auto gap-x-7 gap-y-16 grid grid-cols-4 ">
          {leaders.map((leader) => (
            <BoardOfDirector key={leader.name} {...leader} />
          ))}
        </div>
      </section>
