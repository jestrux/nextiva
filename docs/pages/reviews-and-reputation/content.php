<div class="mt-8">
    <section class="md:py-20 overflow-hidden px-4 md:px-0 flex flex-col gap-10 md:gap-16 items-center justify-center relative">
        <div class="container md:px-12 flex flex-col items-center justify-center relative">
            <div class="flex-1 flex flex-col items-center text-center md:max-w-5xl"><span class="mb-4 md:text-base text-xs py-2 pl-3 pr-3.5 rounded-full bg-gradient-to-r from-content/10 via-content/10 to-content/0 font-light inline-flex items-center gap-1.5 w-fit"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" class="mb-0.5 w-4 md:w-5">
                    ...
                    </svg><span class="opacity-60">Nextiva ComReviews &amp; Reputation</span></span>
                <h1 class="text-2xl md:text-6xl md:leading-tight font-medium mb-2 md:mb-4">Turn Negative Online Post<span class="hidden md:inline"><br></span> <!-- -->and Review into Fans</h1>
                <p class="mb-8 opacity-80 font-normal text-sm/loose md:text-lg/loose max-w-2xl">By responding instantaneously to customers feedback has proven to be the best way to turn dissatisfied customers and prospects to promoters.</p>
        ...
        <div class="max-w-5xl mx-auto"><img class="w-full" src="/img/reviews-and-reputation/reviews-page-banner.png" alt=""></div>
        <div class="bottom-highlight-gradient"></div>
    </section>
    <section class="py-20 relative z-10">
        <div class="w-full flex justify-center" style="position:absolute;top:0">
            <div class="w-full h-px bg-gradient-to-r from-content/[0.03] via-content/50 to-content-[0.03]"></div>
        </div>
        <div class="px-6 max-w-7xl mx-auto mb-16 flex gap-12 items-end">
            <div class="flex-shrink-0 text-3xl">Trusted by local brands<span class="hidden md:inline"><br></span>and businesses<span class="hidden md:inline"><br></span></div>
            <div class="flex-1 grid grid-cols-3 gap-4">
                <div class="border-l border-b border-b-content/[0.008] border-t border-content/10 bg-gradient-to-br from-content/10 via-content/[0.07] to-transparent rounded-lg max-w-lg py-2.5 px-2 flex items-center gap-3">
                    <div class="ml-1 w-8 h-8 rounded-full"><img src="img/businesses/featured1.svg" alt=""></div>
                    <p class="flex-1 text-xs/relaxed font-light opacity-80">Best business phone system by U.S. News four years in a row.</p>
                </div>
                <div class="border-l border-b border-b-content/[0.008] border-t border-content/10 bg-gradient-to-br from-content/10 via-content/[0.07] to-transparent rounded-lg max-w-lg py-2.5 px-2 flex items-center gap-3">
                    <div class="ml-1 w-8 h-8 rounded-full"><img src="img/businesses/featured2.svg" alt=""></div>
                    <p class="flex-1 text-xs/relaxed font-light opacity-80">Best business phone system by U.S. News four years in a row.</p>
                </div>
                <div class="border-l border-b border-b-content/[0.008] border-t border-content/10 bg-gradient-to-br from-content/10 via-content/[0.07] to-transparent rounded-lg max-w-lg py-2.5 px-2 flex items-center gap-3">
                    <div class="ml-1 w-8 h-8 rounded-full"><img src="img/businesses/featured3.svg" alt=""></div>
                    <p class="flex-1 text-xs/relaxed font-light opacity-80">Best business phone system by U.S. News four years in a row.</p>
                </div>
            </div>
        </div>
        <div class="flex gap-1.5 items-center justify-between text-content/5"><img class="max-h-12 max-w-[100px]" src="img/businesses/chair.svg" alt="chair"><img class="max-h-12 max-w-[100px]" src="img/businesses/poly.svg" alt="poly"><img class="max-h-12 max-w-[100px]" src="img/businesses/panasonic.svg" alt="panasonic"><img class="max-h-12 max-w-[100px]" src="img/businesses/cisco.svg" alt="cisco"><img class="max-h-12 max-w-[100px]" src="img/businesses/tacobell.svg" alt="tacobell"><img class="max-h-12 max-w-[100px]" src="img/businesses/amazon.svg" alt="amazon"><img class="max-h-12 max-w-[100px]" src="img/businesses/chair.svg" alt="chair"><img class="max-h-12 max-w-[100px]" src="img/businesses/poly.svg" alt="poly"></div>
    ...
    <section class="py-20 relative">
        <div class="container">
            <div class="flex flex-col gap-2 items-center justify-center text-center">
                <h2 class="text-2xl md:text-6xl/tight font-medium">Never miss an online review... bring it<span class="hidden md:inline"><br></span>together with all customer conversations</h2>
            </div>
            <div class="mt-20 max-w-6xl mx-auto">
                <div class="grid grid-cols-3 gap-6 relative">
                    <div class="relative p-px rounded-xl overflow-hidden">
                        ...
                        <div class="min-h-full relative rounded-xl bg-canvas p-5 flex flex-col">
                            <div class="w-12 h-12 rounded-full flex items-center justify-center border border-content/10 bg-gradient-to-br from-content/[0.08] via-content/[0.08] to-content/0"><svg width="11" height="24" viewBox="0 0 11 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M7.33326 24H2.97139V12.1696H0V8.31792H2.97127V5.57715C2.97127 2.32932 4.28547 0 8.63553 0C9.55557 0 11 0.201761 11 0.201761V3.7783H9.48288C7.93705 3.7783 7.33349 4.28988 7.33349 5.70422V8.31792H10.9421L10.6208 12.1696H7.33337L7.33326 24Z" fill="#1877F2"></path>
                                </svg></div>
                            <div class="flex mt-4  gap-4 items-center">
                                <h3 class="text-lg">Facebook Messenger</h3>
                            </div>
                            <p class="mt-1 font-light text-xs/relaxed opacity-60">Elevate your presence on Facebook with powerful publishing, scheduling and monitoring tools.</p>
                        </div>
                    </div>
                    <div class="relative p-px rounded-xl overflow-hidden">
                        <div class="absolute rounded-xl inset-0 bg-gradient-to-b from-content/20 to-content/0"></div>
                        <div class="min-h-full relative rounded-xl bg-canvas p-5 flex flex-col">
                            <div class="w-12 h-12 rounded-full flex items-center justify-center border border-content/10 bg-gradient-to-br from-content/[0.08] via-content/[0.08] to-content/0"><img class="h-5" src="img/messenger/instagram-logo.png" alt=""></div>
                            <div class="flex mt-4  gap-4 items-center">
                                <h3 class="text-lg">Instagram DM</h3>
                            </div>
                            <p class="mt-1 font-light text-xs/relaxed opacity-60">Never miss a beat and turn the popularity of Instagram into your biggest asset.</p>
                        </div>
                    </div>
                    <div class="relative p-px rounded-xl overflow-hidden">
                        <div class="absolute rounded-xl inset-0 bg-gradient-to-b from-content/20 to-content/0"></div>
                        <div class="min-h-full relative rounded-xl bg-canvas p-5 flex flex-col">
                            <div class="w-12 h-12 rounded-full flex items-center justify-center border border-content/10 bg-gradient-to-br from-content/[0.08] via-content/[0.08] to-content/0"><svg class="h-4" viewBox="0 0 24 24" fill="currentColor">
                                    <path d="M14.2833 11.0024L23.2178 0.845215H21.1006L13.3427 9.66452L7.14656 0.845215H0L9.36984 14.1816L0 24.8329H2.11732L10.3098 15.5194L16.8534 24.8329H24L14.2827 11.0024H14.2833ZM11.3833 14.2991L10.4339 12.9711L2.88022 2.40403H6.1323L12.2282 10.932L13.1776 12.26L21.1016 23.345H17.8495L11.3833 14.2996V14.2991Z"></path>
                                </svg></div>
                            <div class="flex mt-4  gap-4 items-center">
                                <h3 class="text-lg">X(Formerly Twitter)</h3>
                            </div>
                            <p class="mt-1 font-light text-xs/relaxed opacity-60">Grow and build upon your X (formerly Twitter) following with powerful publishing &amp; listening features.</p>
                        </div>
                    </div>
                    <div class="relative p-px rounded-xl overflow-hidden">
                        <div class="absolute rounded-xl inset-0 bg-gradient-to-b from-content/20 to-content/0"></div>
                        <div class="min-h-full relative rounded-xl bg-canvas p-5 flex flex-col">
                            <div class="w-12 h-12 rounded-full flex items-center justify-center border border-content/10 bg-gradient-to-br from-content/[0.08] via-content/[0.08] to-content/0"><svg class="h-5" viewBox="0 0 24 25" fill="none">
                                    <path d="M22.2225 0.845947H1.7715C0.795 0.845947 0 1.6207 0 2.5747V23.1127C0 24.0689 0.795 24.8452 1.7715 24.8452H22.224C23.2027 24.8452 24 24.0689 24 23.1127V2.5747C24 1.6207 23.2027 0.845947 22.2225 0.845947Z" fill="#0177B5"></path>
                                    <path d="M3.55769 9.84307H7.12394V21.2956H3.55769V9.84307ZM5.33819 4.14307C6.47594 4.14307 7.40069 5.06782 7.40069 6.20557C7.40069 7.34332 6.47594 8.27032 5.33894 8.27032C4.79163 8.26913 4.26706 8.05124 3.87999 7.6643C3.49291 7.27736 3.27482 6.75288 3.27344 6.20557C3.27344 5.93453 3.32686 5.66614 3.43065 5.41576C3.53444 5.16538 3.68657 4.93791 3.87832 4.74636C4.07008 4.55481 4.29772 4.40294 4.54821 4.29942C4.79871 4.1959 5.06715 4.14277 5.33819 4.14307ZM9.35069 9.84307H12.7647V11.4083H12.8119C13.2874 10.5083 14.4484 9.55882 16.1869 9.55882C19.7914 9.55882 20.4567 11.9311 20.4567 15.0143V21.2963H16.8994V15.7253C16.8994 14.3978 16.8754 12.6878 15.0499 12.6878C13.1974 12.6878 12.9124 14.1353 12.9124 15.6278V21.2933H9.35594V9.84082L9.35069 9.84307Z" fill="white"></path>
                                </svg></div>
                            <div class="flex mt-4  gap-4 items-center">
                                <h3 class="text-lg">Linkedin</h3>
                            </div>
                            <p class="mt-1 font-light text-xs/relaxed opacity-60">Manage your brand presence with more personalized &amp; professional conversations on LinkedIn.</p>
                        </div>
                    </div>
                    <div class="relative p-px rounded-xl overflow-hidden">
                        <div class="absolute rounded-xl inset-0 bg-gradient-to-b from-content/20 to-content/0"></div>
                        <div class="min-h-full relative rounded-xl bg-canvas p-5 flex flex-col">
                            <div class="w-12 h-12 rounded-full flex items-center justify-center border border-content/10 bg-gradient-to-br from-content/[0.08] via-content/[0.08] to-content/0"><svg class="h-5" viewBox="0 0 24 25" fill="none">
                                    <path d="M23.4761 7.06883C23.3381 6.55981 23.0692 6.09577 22.6963 5.72283C22.3233 5.34989 21.8593 5.08102 21.3503 4.94296C19.4865 4.43408 11.985 4.43408 11.985 4.43408C11.985 4.43408 4.48313 4.44908 2.619 4.95796C2.10997 5.09602 1.64594 5.36489 1.27299 5.73783C0.900053 6.11077 0.631192 6.57481 0.493125 7.08383C0 8.94796 0 12.8453 0 12.8453C0 12.8453 0 16.7427 0.5085 18.6218C0.646567 19.1309 0.915428 19.5949 1.28837 19.9678C1.66131 20.3408 2.12535 20.6096 2.63438 20.7477C4.49813 21.2566 12 21.2566 12 21.2566C12 21.2566 19.5019 21.2566 21.366 20.7481C21.875 20.61 22.3391 20.3412 22.712 19.9682C23.0849 19.5953 23.3538 19.1312 23.4919 18.6222C24 16.7581 24 12.8453 24 12.8453C24 12.8453 23.985 8.94796 23.4761 7.06883Z" fill="#FF0000"></path>
                                    <path d="M9.59803 16.4497L15.8212 12.8452L9.59766 9.24072L9.59803 16.4497Z" fill="white"></path>
                                </svg></div>
                            <div class="flex mt-4  gap-4 items-center">
                                <h3 class="text-lg">Youtube</h3>
                            </div>
                            <p class="mt-1 font-light text-xs/relaxed opacity-60">Build better relationships with your YouTube fans and followers from a single, scalable platform.</p>
                        </div>
                    </div>
                    <div class="relative p-px rounded-xl overflow-hidden">
                        <div class="absolute rounded-xl inset-0 bg-gradient-to-b from-content/20 to-content/0"></div>
                        <div class="min-h-full relative rounded-xl bg-canvas p-5 flex flex-col">
                            <div class="w-12 h-12 rounded-full flex items-center justify-center border border-content/10 bg-gradient-to-br from-content/[0.08] via-content/[0.08] to-content/0"><svg class="h-5" viewBox="0 0 25 25" fill="none">
                                    <path d="M12.031 24.2281C18.6583 24.2281 24.0308 18.8556 24.0308 12.2283C24.0308 5.601 18.6583 0.228516 12.031 0.228516C5.40374 0.228516 0.03125 5.601 0.03125 12.2283C0.03125 18.8556 5.40374 24.2281 12.031 24.2281Z" fill="#CB2027"></path>
                                    <path d="M12.9996 16.2974C12.0924 16.2272 11.7113 15.7774 10.9998 15.3455C10.6088 17.3971 10.1309 19.3637 8.71548 20.3911C8.27804 17.2903 9.35677 14.9613 9.85775 12.4892C9.00383 11.0517 9.96042 8.15839 11.7615 8.87135C13.9782 9.74794 9.84235 14.2163 12.6189 14.7743C15.5175 15.357 16.7009 9.74473 14.9032 7.91925C12.3059 5.28369 7.34305 7.85935 7.95333 11.6323C8.10199 12.5546 9.05517 12.8346 8.33408 14.1074C6.67181 13.7392 6.17597 12.4282 6.23971 10.6804C6.3426 7.81935 8.81046 5.81611 11.2858 5.53888C14.4163 5.1885 17.3546 6.68842 17.7601 9.63307C18.2164 12.9566 16.3468 16.5558 12.9996 16.2974Z" fill="#F1F2F2"></path>
                                </svg></div>
                            <div class="flex mt-4  gap-4 items-center">
                                <h3 class="text-lg">Pinterest</h3><span class=" inline-flex px-3 py-1.5 text-[#6A83FB] rounded-full bg-content/[0.1] text-xs/none">Coming soon</span>
                            </div>
                            <p class="mt-1 font-light text-xs/relaxed opacity-60">Turn your Pinterest content into real, long lasting business relationships.</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="mt-12 flex items-center justify-center"><a href="#" class="p-3 group hover:opacity-90 mt-6 inline-flex items-center gap-2">Get started<svg class="group-hover:translate-x-0.5 transition-transform w-5 h-5 mt-0.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
    ...
    <div class="relative py-24">
        ...
        <div class="max-w-6xl mx-auto">
            <div class="flex items-center false gap-24">
                <div class="flex-shrink-0 w-5/12"><img class="w-full" src="/img/reviews-and-reputation/location-review.png" alt=""></div>
                <div class="w-7/12 pb-8">
                    <div class="flex flex-col items-start">
                        <div class="flex items-center gap-2 text-sm/none">
                            <div class="bg-success/20 text-success h-10 px-5 rounded-xl flex items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" class="w-5">
                            ...
                            <div class="bg-warning/20 text-warning h-10 px-5 rounded-xl flex items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" class="w-5">
                                ...
                                </svg>Beats others by 20%</div>
                        </div>
                        <div class="mt-6">
                            <h3 class="text-2xl md:text-5xl/[1.1]">Location Reviews<span class="hidden md:inline"><br></span></h3>
                            <p class="mt-4 text-base/loose opacity-70 max-w-xl">Boost your local &amp; digital brand reputation by keeping a close eye on your business listings. Monitor location based reviews on platforms like Facebook, Google, TripAdvisor, Yelp and more.</p>
                        </div>
            ...
            <div style="grid-template-columns:repeat(3, minmax(0, 1fr))" class="mt-12 grid grid-cols-4 gap-6 relative">
                <div class="relative p-px rounded-xl overflow-hidden">
                    ...
                    <div class="bg-canvas min-h-full relative rounded-xl p-5 flex flex-col">
                        ...
                        <h3 class="mt-4 text-lg">72%</h3>
                        <p class="mt-1 font-light text-xs/relaxed opacity-60">of consumers say that positive reviews make them trust a local business more</p>
                    </div>
                </div>
                <div class="relative p-px rounded-xl overflow-hidden">
                    <div class="absolute rounded-xl inset-0 bg-gradient-to-b from-content/20 to-content/0"></div>
                    <div class="bg-canvas min-h-full relative rounded-xl p-5 flex flex-col">
                        ...
                        <h3 class="mt-4 text-lg">65%</h3>
                        <p class="mt-1 font-light text-xs/relaxed opacity-60">of consumers say reliability, expertise, professionalism are the most important reputation traits for local businesses.</p>
                    </div>
                </div>
                <div class="relative p-px rounded-xl overflow-hidden">
                    <div class="absolute rounded-xl inset-0 bg-gradient-to-b from-content/20 to-content/0"></div>
                    <div class="bg-canvas min-h-full relative rounded-xl p-5 flex flex-col">
                        ...
                        <h3 class="mt-4 text-lg">90%</h3>
                        <p class="mt-1 font-light text-xs/relaxed opacity-60">of consumers read online reviews before visiting a business</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="relative py-24">
        ...
        <div class="max-w-6xl mx-auto">
            <div class="flex items-center flex-row-reverse gap-24">
                <div class="flex-shrink-0 w-5/12"><img class="w-full" src="/img/reviews-and-reputation/ecommarce-review.png" alt=""></div>
                <div class="w-7/12 pb-8">
                    <div class="flex flex-col items-start">
                        <div class="flex items-center gap-2 text-sm/none">
                            <div class="bg-success/20 text-success h-10 px-5 rounded-xl flex items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" class="w-5">
                        ...
                        <div class="mt-6">
                            <h3 class="text-2xl md:text-5xl/[1.1]">eCommerce Reviews<span class="hidden md:inline"><br></span></h3>
                            <p class="mt-4 text-base/loose opacity-70 max-w-xl">Build better product reviews and drive more sales by integrating ecommerce platforms like Amazon and Flipkart. You can even listen and respond to reviews on your own online store and website!</p>
                        </div>
                        <div class="mt-8 flex items-center gap-3"><button class="button 
		false 
		false
            ...
            <div style="grid-template-columns:repeat(3, minmax(0, 1fr))" class="mt-12 grid grid-cols-4 gap-6 relative">
                <div class="relative p-px rounded-xl overflow-hidden">
                    ...
                    <div class="bg-canvas min-h-full relative rounded-xl p-5 flex flex-col">
                        ...
                        <h3 class="mt-4 text-lg">94%</h3>
                        <p class="mt-1 font-light text-xs/relaxed opacity-60">of customers avoided a business after reading negative reviews online.</p>
                    </div>
                </div>
                <div class="relative p-px rounded-xl overflow-hidden">
                    <div class="absolute rounded-xl inset-0 bg-gradient-to-b from-content/20 to-content/0"></div>
                    <div class="bg-canvas min-h-full relative rounded-xl p-5 flex flex-col">
                        ...
                        <h3 class="mt-4 text-lg">88%</h3>
                        <p class="mt-1 font-light text-xs/relaxed opacity-60">of consumers trust online reviews as much as personal recommendations.</p>
                    </div>
                </div>
                <div class="relative p-px rounded-xl overflow-hidden">
                    <div class="absolute rounded-xl inset-0 bg-gradient-to-b from-content/20 to-content/0"></div>
                    <div class="bg-canvas min-h-full relative rounded-xl p-5 flex flex-col">
                        ...
                        <h3 class="mt-4 text-lg">86%</h3>
                        <p class="mt-1 font-light text-xs/relaxed opacity-60">will hesitate to purchase from a business that has negative online reviews.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="relative py-24">
        ...
        <div class="max-w-6xl mx-auto">
            <div class="flex items-center false gap-24">
                <div class="flex-shrink-0 w-5/12"><img class="w-full" src="/img/reviews-and-reputation/app-reviews.png" alt=""></div>
                <div class="w-7/12 pb-8">
                    <div class="flex flex-col items-start">
                        <div class="flex items-center gap-2 text-sm/none">
                            <div class="bg-success/20 text-success h-10 px-5 rounded-xl flex items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" class="w-5">
                        ...
                        <div class="mt-6">
                            <h3 class="text-2xl md:text-5xl/[1.1]">App Reviews<span class="hidden md:inline"><br></span></h3>
                            <p class="mt-4 text-base/loose opacity-70 max-w-xl">Have iOS or Android applications? Increase downloads and improve your reputation by monitoring reviews on both platforms
                                all from a single platform.</p>
                        </div>
                        <div class="mt-8 flex items-center gap-3"><button class="button 
		false 
		false
	...
	">Get started</button></div>
            ...
            <div style="grid-template-columns:repeat(4, minmax(0, 1fr))" class="mt-12 grid grid-cols-4 gap-6 relative">
                <div class="relative p-px rounded-xl overflow-hidden">
                    <div class="absolute rounded-xl inset-0 bg-gradient-to-b from-content/20 to-content/0"></div>
                    <div class="bg-canvas min-h-full relative rounded-xl p-5 flex flex-col">
                        <div class="mb-2 opacity-50"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" class="h-6">
                        ...
                        <h3 class="mt-4 text-lg">$935.2B</h3>
                        <p class="mt-1 font-light text-xs/relaxed opacity-60">is the projected global app revenue expected to be surpassed by 2024.</p>
                    </div>
                </div>
                <div class="relative p-px rounded-xl overflow-hidden">
                    <div class="absolute rounded-xl inset-0 bg-gradient-to-b from-content/20 to-content/0"></div>
                    <div class="bg-canvas min-h-full relative rounded-xl p-5 flex flex-col">
                        ...
                        <h3 class="mt-4 text-lg">79%</h3>
                        <p class="mt-1 font-light text-xs/relaxed opacity-60">of consumers check ratings and reviews before downloading an app.</p>
                    </div>
                </div>
                <div class="relative p-px rounded-xl overflow-hidden">
                    <div class="absolute rounded-xl inset-0 bg-gradient-to-b from-content/20 to-content/0"></div>
                    <div class="bg-canvas min-h-full relative rounded-xl p-5 flex flex-col">
                        ...
                        <h3 class="mt-4 text-lg">55%</h3>
                        <p class="mt-1 font-light text-xs/relaxed opacity-60">check rating and reviews before making an in-app purchase.</p>
                    </div>
                </div>
                <div class="relative p-px rounded-xl overflow-hidden">
                    <div class="absolute rounded-xl inset-0 bg-gradient-to-b from-content/20 to-content/0"></div>
                    <div class="bg-canvas min-h-full relative rounded-xl p-5 flex flex-col">
                        ...
                        <h3 class="mt-4 text-lg">75%</h3>
                        <p class="mt-1 font-light text-xs/relaxed opacity-60">of people can be influenced to install the app on Apple devices through app reviews.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="relative py-20 ">
        ...
        <div class="max-w-6xl mx-auto space-y-12">
            <div class="flex flex-col items-center text-center">
                <div class="mt-6">
                    <h3 class="text-2xl md:text-5xl/[1.1]">Work smarter using AI<span class="hidden md:inline"><br></span>and automation<span class="hidden md:inline"><br></span></h3>
                    <p class="mt-4 text-base/loose opacity-70 max-w-xl">Put your social support on autopilot with AI-powered experience. Reduce repetitive and manual tasks in minutes.
                        Boost your team's effectiveness. Automatically prioritize status and filter incoming customer messages, allowing you to stay focused and address messages based on their significance.</p>
                </div>
                <div class="mt-8 flex items-center gap-3"><a href="#" class="hover:opacity-90 mt-6 inline-flex items-center gap-3">Learn more<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5 mt-0.5">
                            <path fill-rule="evenodd" d="M12.97 3.97a.75.75 0 011.06 0l7.5 7.5a.75.75 0 010 1.06l-7.5 7.5a.75.75 0 11-1.06-1.06l6.22-6.22H3a.75.75 0 010-1.5h16.19l-6.22-6.22a.75.75 0 010-1.06z" clip-rule="evenodd"></path>
                        </svg></a></div>
            </div>
            <div class="flex justify-center gap-6"><img src="/img/social-marketing/nextiva-ai.png" class="w-5/12" alt=""><img src="/img/social-marketing/with-nextiva-ai.png" class="w-5/12" alt=""></div>
        </div>
    </section>
    <section class="py-20 relative">
        <div class="max-w-6xl mx-auto">
            <div class="flex flex-col items-center text-center">
                <div class="mt-6">
                    <h3 class="text-2xl md:text-5xl/[1.1]">Features we wouldn't let<span class="hidden md:inline"><br></span> you go without<span class="hidden md:inline"><br></span></h3>
            ...
            <div class="flex pt-16 justify-center">
                <div class="max-w-2xl mx-auto flex flex-col items-center gap-6">
                    <p class="text-2xl/relaxed text-center">“<!-- -->NextivaOne aims to remove the friction, frustration, inefficiencies, and errors that come.<!-- -->”</p>
                    <div class="flex items-center justify-center gap-3"><img class="w-14" src="img/reviews-and-reputation/RyanPetersen.png" alt="">
                        <div class="flex flex-col"><span>Ryan Petersen, <!-- -->,</span><span class="opacity-60">Founder and CEO of Flexport</span></div>
                    </div>
                </div>
            </div>
        </div>
