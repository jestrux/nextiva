<div class="mt-8">
	<section class="md:py-20 overflow-hidden px-4 md:px-0 flex flex-col gap-10 md:gap-16 items-center justify-center relative">
		<div class="container md:px-12 flex flex-col items-center justify-center relative">
			<div class="flex-1 flex flex-col items-center text-center md:max-w-5xl"><span class="mb-4 md:text-base text-xs py-2 pl-3 pr-3.5 rounded-full bg-gradient-to-r from-content/10 via-content/10 to-content/0 font-light inline-flex items-center gap-1.5 w-fit"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" class="mb-0.5 w-4 md:w-5">
					...
					</svg><span class="opacity-60">AI Powered</span></span>
				<h1 class="text-2xl md:text-6xl md:leading-tight font-medium mb-2 md:mb-4">Provide Amazing Email<span class="hidden md:inline"><br></span>Customer Experience</h1>
				<p class="mb-8 opacity-80 font-normal text-sm/loose md:text-lg/loose max-w-2xl mx-auto">AI-Powered Email for Sales, Service, Marketing. Designed for High-Performance Teams. Reclaim up to 4 hours every week.</p>
				<div class="flex flex-col md:flex-row items-center gap-3"><a href="#" class="button">Get started</a><a href="#" class="button button-outline">Case Studies</a></div>
			</div>
		</div><img class="w-full" src="img/email/banner2.png" alt="">
	...
	<div class="relative py-24">
		...
		<div class="max-w-6xl mx-auto">
			<div class="flex items-center false gap-24">
				<div class="flex-shrink-0 w-5/12"><img class="w-full" src="/img/email/boost.png" alt=""></div>
	...
	<div class="relative py-24">
		...
		<div class="max-w-6xl mx-auto">
			<div class="flex items-center flex-row-reverse gap-24">
				<div class="flex-shrink-0 w-5/12"><img class="w-full" src="/img/email/compliance.png" alt=""></div>
				<div class="w-7/12 pb-8">
					<div class="flex flex-col items-start">
						<div class="flex items-center gap-2 text-sm/none">
							<div class="bg-success/20 text-success h-10 px-5 rounded-xl flex items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" class="w-5">
	...
	<div class="relative py-24">
		...
		<div class="max-w-6xl mx-auto">
			<div class="flex items-center false gap-24">
				<div class="flex-shrink-0 w-5/12"><img class="w-full" src="/img/email/collaborate.png" alt=""></div>
				<div class="w-7/12 pb-8">
					<div class="flex flex-col items-start">
						<div class="flex items-center gap-2 text-sm/none">
							<div class="bg-success/20 text-success h-10 px-5 rounded-xl flex items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" class="w-5">
	...
	<section class="py-20 mb-20 relative">
	...
	">Get started</button></div>
		...
		<div class="max-w-5xl mx-auto my-12"><img src="img/email/integrations.png" alt=""></div>
